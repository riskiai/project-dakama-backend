    ...
    <div class="border-2 border-black">
            ...
            <table class="w-full">
                ...
                <tr class="text-[12px]">
                    ...
                    <td class="p-1 text-left">: {{ $slip['attendances']->first()->start_time->format('j') }} sd
                        {{ $slip['attendances']->last()->start_time->format('j F Y') }}
                    </td>
                </tr>
                <tr class="text-[12px]">
            ...
            <table style="table-layout: fixed" class="w-full border-collapse">
                ...
                <tbody>
                    <tr class="text-[12px]">
                        ...
                        <?php foreach ($week as $d): ?>
                            <td class="border-r border-t border-black p-1 text-center">
                                {{ $slip['attendances'][$d->format('Y-m-d')]->project->company->contactType->name }}
                            </td>
                        <?php endforeach; ?>
                    ...
                    <tr class="text-[12px]">
                        ...
                        <?php foreach ($week as $d): ?>
                            <td class="border-r border-t border-black p-1 text-center">
                                {{ $slip['attendances'][$d->format('Y-m-d')]->project->name }}
                            </td>
                        <?php endforeach; ?>
        ...
        <table class="w-full my-3 border-collapse">
            ...
            <tr class="text-[12px]">
                ...
                <td class="p-1 text-right">Rp</td>
                <td class="text-right p-1">
                    {{ number_format(count($totalJHK) * $slip['reports'][2]['rate'], 0, ',', '.') }}
                </td>
            </tr>
            <tr class="text-[12px]">
                ...
                <td class="p-1 text-right">Rp</td>
                <td class="text-right p-1">
                    {{ number_format($slip['bonus_jhk'] * $slip['reports'][3]['rate'], 0, ',', '.') }}
                </td>
            </tr> --}}
        </table>
        ...
        <table class="w-full font-bold border-collapse">
            <tr class="text-[12px]">
                ...
                <td class="p-1 border-y border-black text-right">
                    {{ number_format($totalAmount - $slip['kasbon'], 0, ',', '.') }}
                </td>
            </tr>
        </table>
    </div>
